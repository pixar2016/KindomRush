...
public class ConvertPathToJson : EditorWindow
{
    /// <summary>
    /// 编辑器窗口实例
    /// </summary>
    private static ConvertPathToJson instance;
    ...
    [MenuItem("Plugins/PathTools/WritePathToJson")]
    ...
    {
        instance = EditorWindow.GetWindow<ConvertPathToJson>();
